...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    dognames_dic = {name: 1 for name in line}
    ...
    for key in key_list:
        ...
        ind_0 = str(results_dic[key][0])
        ind_1 = str(results_dic[key][1])
        # Pet Image Label IS of Dog (e.g. found in dognames_dic)
        if ind_0 not in dognames_dic.keys():
            if ind_1 not in dognames_dic.keys():
                new_val = [0, 0]
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            # appends (0, 0) because both labels aren't dogs
                ...
                new_val = [1, 1]
        results_dic[key].extend(new_val)
    print(results_dic)
